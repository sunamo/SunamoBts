...
{
    /// <summary>
    ///     Converts IList to List of T numbers. Default value will be used when parsed element is not a number to return a recognizable bad value.
    /// </summary>
    ...
    /// <summary>
    ///     If list does not have required length or element in list cannot be parsed to T, returns null
    /// </summary>
    /// <param name="parseMethod"></param>
    /// <param name="list"></param>
    ...
    ///     Second type parameter is without genericity
    /// </summary>
    /// <typeparam name="T"></typeparam>
    ...
    /// <summary>
    ///     If element in list cannot be parsed to T, returns null
    /// </summary>
    /// <param name="parseMethod"></param>
    /// <param name="list"></param>
    /// <param name="requiredLength"></param>
